...
<body onload="myFunction()" style="margin:0;">
    ...
    padding: 2rem 2rem 4rem 4rem;">
  		<h1 class="display-3" style="text-align: center;color: #8ecd4e;">Your email has already been verified!</h1>
  		<hr><br><br>
  		<h3 class="display-5" style="text-align: center; color: #054978;"><strong>Close this page.</strong></h3><br>
  		<p style="text-align: center;">Having trouble? Mail us : <a href="mailto:support@ivtree.com" target="_top" style="color: #054978;"> support@ivtree.com</a>
  		</p>
		</div>
